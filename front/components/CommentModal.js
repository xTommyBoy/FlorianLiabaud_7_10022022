...
export default function CommentModal({ comments, setComments, post, parentEvent }) {
  ...
  function addComment(comment){
    comment.user = {displayName: connectedUser?.displayName, profileImageUrl: connectedUser?.profileImageUrl}
                ...
                <div className="flex px-4 pt-5 pb-2.5 sm:px-6 bg-white rounded-b-2xl shadow-xl">
                  <div className="w-full">
                    ...
                    <div className="mt-7 flex w-full">
                      ...
                      <div>
                      <CommentInput addComment={addComment} currentPostId={post.id} />
                    </div>
                  </div>
                </div>
              </div>
